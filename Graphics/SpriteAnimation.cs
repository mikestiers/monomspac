...
namespace MsPacMan.Graphics
{
    ...
    {
        private List<SpriteAnimationFrame> _frames = new List<SpriteAnimationFrame>(); // this is a shortcut to not creating a constructor
        ...
        public SpriteAnimationFrame CurrentFrame
        {
            ...
            {
                return _frames
                    .Where(f => f.TimeStamp <= PlaybackProgress) // lambda expression
